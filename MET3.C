	...
	for( int s = 0; s < nsystematic; s++ ){
		...
		for( int i = 0; i < nvariable_R; i++ ){
			...
			for( int k = 0; k < nbinpT; k++ ){
				...
				h_resol_pT_fit   [i][1][k][Zee][s] -> Add( h_resol_pT   [i][TTsemiTbar_ee][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zee][s] -> Add( h_resol_pT   [i][WW_ee        ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zee][s] -> Add( h_resol_pT   [i][WZTo2L2Q_ee  ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zee][s] -> Add( h_resol_pT   [i][WZTo3LNu_ee  ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zee][s] -> Add( h_resol_pT   [i][ZZTo4L_ee    ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zee][s] -> Add( h_resol_pT   [i][ZZTo2L2Q_ee  ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zee][s] -> Add( h_resol_pT   [i][ZZTo2L2Nu_ee ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zee][s] -> Add( h_resol_pT   [i][WWW_ee       ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zee][s] -> Add( h_resol_pT   [i][WWZ_ee       ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zee][s] -> Add( h_resol_pT   [i][WZZ_ee       ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zee][s] -> Add( h_resol_pT   [i][ZZZ_ee       ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zee][s] -> Add( h_resol_pT   [i][SingleTop1_ee][k][s] ); 
				...
				h_resol_pT_fit   [i][1][k][Zmumu][s] -> Add( h_resol_pT   [i][TTsemiTbar_mm  ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zmumu][s] -> Add( h_resol_pT   [i][WW_mm          ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zmumu][s] -> Add( h_resol_pT   [i][WZTo2L2Q_mm    ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zmumu][s] -> Add( h_resol_pT   [i][WZTo3LNu_mm    ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zmumu][s] -> Add( h_resol_pT   [i][ZZTo4L_mm      ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zmumu][s] -> Add( h_resol_pT   [i][ZZTo2L2Q_mm    ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zmumu][s] -> Add( h_resol_pT   [i][ZZTo2L2Nu_mm   ][k][s] );
				h_resol_pT_fit   [i][1][k][Zmumu][s] -> Add( h_resol_pT   [i][WWW_mm         ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zmumu][s] -> Add( h_resol_pT   [i][WWZ_mm         ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zmumu][s] -> Add( h_resol_pT   [i][WZZ_mm         ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zmumu][s] -> Add( h_resol_pT   [i][ZZZ_mm         ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zmumu][s] -> Add( h_resol_pT   [i][SingleTop1_mm  ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zmumu][s] -> Add( h_resol_pT   [i][SingleTop2_mm  ][k][s] ); 
				h_resol_pT_fit   [i][1][k][Zmumu][s] -> Add( h_resol_pT   [i][SingleTop3_mm  ][k][s] ); 
			...
			for( int k = 0; k < nbinNVtx; k++ ){
				...
				h_resol_NVtx_fit   [i][1][k][Zee][s] -> Add( h_resol_NVtx   [i][TTsemiTbar_ee][k][s] );
				h_resol_NVtx_fit   [i][1][k][Zee][s] -> Add( h_resol_NVtx   [i][WW_ee        ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zee][s] -> Add( h_resol_NVtx   [i][WZTo2L2Q_ee  ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zee][s] -> Add( h_resol_NVtx   [i][WZTo3LNu_ee  ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zee][s] -> Add( h_resol_NVtx   [i][ZZTo4L_ee    ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zee][s] -> Add( h_resol_NVtx   [i][ZZTo2L2Q_ee  ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zee][s] -> Add( h_resol_NVtx   [i][ZZTo2L2Nu_ee ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zee][s] -> Add( h_resol_NVtx   [i][WWW_ee       ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zee][s] -> Add( h_resol_NVtx   [i][WWZ_ee       ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zee][s] -> Add( h_resol_NVtx   [i][WZZ_ee       ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zee][s] -> Add( h_resol_NVtx   [i][ZZZ_ee       ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zee][s] -> Add( h_resol_NVtx   [i][SingleTop1_ee][k][s] ); 
				...
				h_resol_NVtx_fit   [i][1][k][Zmumu][s] -> Add( h_resol_NVtx   [i][TTsemiTbar_mm  ][k][s] );
				h_resol_NVtx_fit   [i][1][k][Zmumu][s] -> Add( h_resol_NVtx   [i][WW_mm          ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zmumu][s] -> Add( h_resol_NVtx   [i][WZTo2L2Q_mm    ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zmumu][s] -> Add( h_resol_NVtx   [i][WZTo3LNu_mm    ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zmumu][s] -> Add( h_resol_NVtx   [i][ZZTo4L_mm      ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zmumu][s] -> Add( h_resol_NVtx   [i][ZZTo2L2Q_mm    ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zmumu][s] -> Add( h_resol_NVtx   [i][ZZTo2L2Nu_mm   ][k][s] );
				h_resol_NVtx_fit   [i][1][k][Zmumu][s] -> Add( h_resol_NVtx   [i][WWW_mm         ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zmumu][s] -> Add( h_resol_NVtx   [i][WWZ_mm         ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zmumu][s] -> Add( h_resol_NVtx   [i][WZZ_mm         ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zmumu][s] -> Add( h_resol_NVtx   [i][ZZZ_mm         ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zmumu][s] -> Add( h_resol_NVtx   [i][SingleTop1_mm  ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zmumu][s] -> Add( h_resol_NVtx   [i][SingleTop2_mm  ][k][s] ); 
				h_resol_NVtx_fit   [i][1][k][Zmumu][s] -> Add( h_resol_NVtx   [i][SingleTop3_mm  ][k][s] ); 
	...
	for( int i = 0; i < nvariable_R; i++){
		...
		for( int k = 0; k < nbinpT; k++ ){
			...
			for( int m = 0; m < nkanal; m++ ){
				...
				if(  m == Gamma  &&  current_pT < 50.  ) { 
					...
					GetResolution( m  , i, pT, k, ySR[0][3][m],    ySR[1][3][m],    ySR[2][3][m], "GJetsVoigtian", JECu    );   // JEC-up
					GetResolution( m  , i, pT, k, ySR[0][4][m],    ySR[1][4][m],    ySR[2][4][m], "GJetsVoigtian", JECd    );   // JEC-do
					GetResolution( m  , i, pT, k, ySR[0][5][m],    ySR[1][5][m],    ySR[2][5][m], "GJetsVoigtian", UnEu    );   // UnE-up 
		...
		for( int k = 0; k < nbinNVtx; k++ ){
			...
			for( int m = 0; m < nkanal; m++ ){
				...
				GetResolution( m  , i, NVtx, k, ySR[0][3][m],    ySR[1][3][m],    ySR[2][3][m], "GJetsVoigtian", JECu    );   // JEC-up
				GetResolution( m  , i, NVtx, k, ySR[0][4][m],    ySR[1][4][m],    ySR[2][4][m], "GJetsVoigtian", JECd    );   // JEC-do
				GetResolution( m  , i, NVtx, k, ySR[0][5][m],    ySR[1][5][m],    ySR[2][5][m], "GJetsVoigtian", UnEu    );   // UnE-up 
				GetResolution( m  , i, NVtx, k, ySR[0][6][m],    ySR[1][6][m],    ySR[2][6][m], "GJetsVoigtian", UnEd    );   // UnE-do
