...
TString outfileName( "../MVA/training_test_outputs/trainOPT/" + DM + ".root" );   

TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

(TMVA::gConfig().GetIONames()).fWeightFileDir = "../MVA/training_test_outputs/weightsOPT";  // weights output file
