...
eosTargBaseIn = '/gpfs/gaes/cms/store/group/phys_higgs/cmshww/amassiro/RunII/2016/Feb2017/MC/LatinoTrees/altamira'
eosTargBaseOut= '/gpfs/gaes/cms/store/group/phys_higgs/cmshww/amassiro/RunII/2016/Feb2017/MC/LatinoTrees/altamira'
...
for iProd in prodList :
  ...
  elif 'cloudprv' in os.uname()[1] or 'login' in os.uname()[1]:
    if options.iStep == 'Prod' :
        ...
        # Chains of subTargets
          ...
          for iSubStep in  Steps[iStep]['subTargets'] :
            ...
            if selectSample : 
              ...
              #outTree ='/gpfs/csic_users/'+os.getlogin()+'/latino_'+iTarget+'__'+iName+'.root'
              #outTree ='/gpfs/csic_projects/tier3data/LatinosSkims/RunII/2016'+'/latino_'+iTarget+'__'+iName+'.root'
